...
#' @importFrom magrittr %>%
#' @export
plot_stormRefRegions_grid <- function(xmat, ppm, stormResults, plotLoc, filename = "storm_results_refPlots_grid.pdf", calcStocsy = TRUE, n_xticks = 4) {
  ...
  pdf(
    file = str_c(plotLoc, filename), # The directory you want to save the file in
